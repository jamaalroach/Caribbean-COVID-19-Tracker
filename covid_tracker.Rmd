...
output: 
  flexdashboard::flex_dashboard:
    orientation: row
    social: [ "twitter", "facebook", "menu", "instagram" ]
    theme: flatly
...
plot_data <-reactive({carib_data%>%filter(country %in% input$country)})
...
p(" View and compare trends by selecting either the Confirmed Cases or Deaths tab and then Country(ies)")
